...
public class VentanaReporteIngresos extends JFrame {
	...
	private static VentanaReporteIngresos INSTANCE;
	...
	private VentanaReporteIngresos() {
		super();
		initialize();
	}

	public static VentanaReporteIngresos getInstance() {
		if (INSTANCE == null) {
			INSTANCE = new VentanaReporteIngresos();
			return INSTANCE;
		} else {
			return INSTANCE;
		}
	...
	private void initialize() {
		...
		setTitle(idioma.getString("reporte.ingreso"));
		...
		JLabel lblGenerarReportesPor = new JLabel(idioma.getString("reporte.ingreso"));
