...
public class ProfesionalTest {
	...
	ProfesionalDTO nuevo=	new ProfesionalDTO(1, "Flavio", "Mendoza" ,1, 2, "ACTIVO" );
	sistema.agregarProfesional(nuevo);
	assertEquals(sistema.obtenerProfesional().get(0).getEstado(),"ACTIVO");
	}
	@Test
	public void testEliminarProfesional() {
	ProfesionalDTO nuevo=	new ProfesionalDTO(1, "Flavio", "Mendoza" ,1, 2, "ACTIVO" );
	sistema.agregarProfesional(nuevo);
	ProfesionalDTO nuevo2=	new ProfesionalDTO(2, "Marcelo", "Polino" ,2, 3, "ACTIVO" );
	...
	ProfesionalDTO nuevo=	new ProfesionalDTO(1, "Flavio", "Mendoza" ,1, 2, "ACTIVO" );
	sistema.agregarProfesional(nuevo);
	ProfesionalDTO nuevo1=	new ProfesionalDTO(1, "Flavio", "Mendoza" ,1, 3, "ENFERMO" );
	...
	ProfesionalDTO nuevo=new ProfesionalDTO(1, "Flavio", "Mendoza" ,1, 2, "ACTIVO" );
	ProfesionalDTO nuevo1=new ProfesionalDTO(2, "Flavio", "Mendoza" ,1, 2, "ACTIVO" );
	sistema.agregarProfesional(nuevo);
	...
	sistema.agregarProfesional(nuevo);
	sistema.agregarProfesional(nuevo1);
	assertEquals(sistema.obtenerProfesional().size(),2);
	}
