...
public class VentanaAltaUsuario extends JFrame {
	...
	private static VentanaAltaUsuario INSTANCE;
	...
	public static VentanaAltaUsuario getInstance( )
	{
		if(INSTANCE == null)
		{
			INSTANCE = new VentanaAltaUsuario(); 	
			return new VentanaAltaUsuario();
		}
		else
			return INSTANCE;
	}

	private VentanaAltaUsuario() 
	{
		super();
		...
		setTitle(idioma.getString("usuarios.alta"));
